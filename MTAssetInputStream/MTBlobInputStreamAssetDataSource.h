//
//  MTBlobInputStreamAssetDataSource.h
//  MTAssetInputstream
//
...
/// These are the only types of errors which raises MTBlobInputStreamAssetDataSource.
typedef NS_ENUM(NSInteger, MTBlobInputStreamAssetDataSourceErrorCode) {
    MTBlobInputStreamAssetDataSourceErrorCodeOpen = 0,
    MTBlobInputStreamAssetDataSourceErrorCodeRead = 1
};

/// Data source for streaming ALAsset from AssetsLibrary.
@interface MTBlobInputStreamAssetDataSource : NSObject <MTBlobInputStreamDataSource>
/*!
...
/*!
    ...
    @remarks See comments in MTAdjustedAssetReaderPH.h for more info.*/
